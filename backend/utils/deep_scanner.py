...
async def deep_scan_website(url: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # Customer sites may have expired/self-signed certificates.
        # SSL issues are captured and reported as findings by the scanner.
        import ssl
        ssl_ctx = ssl.create_default_context()
        ssl_ctx.check_hostname = False
        ssl_ctx.verify_mode = ssl.CERT_NONE
        async with httpx.AsyncClient(timeout=30.0, follow_redirects=True, verify=ssl_ctx) as client:
