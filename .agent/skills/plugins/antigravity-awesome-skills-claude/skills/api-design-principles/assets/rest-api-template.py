...
app.add_middleware(
    CORSMiddleware,
    allow_origins=os.environ.get("CORS_ALLOWED_ORIGINS", "http://localhost:3000").split(","), # TODO: Set CORS_ALLOWED_ORIGINS env var to a comma-separated list of allowed origins in production
