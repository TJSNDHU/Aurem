    ...
    async def check_rate_limit(
        ...
        if is_blocked:
            return False, {
                ...
                "message": "Rate limit exceeded. For urgent help WhatsApp us at +16134000000",
        ...
        if message_hash:
            ...
            if duplicate_count >= DUPLICATE_MESSAGE_THRESHOLD:
                ...
                return False, {
                    "error": "spam_detected",
                    "message": "Too many identical messages. For urgent help WhatsApp us at +16134000000",
        ...
        if request_count >= limit:
            ...
            return False, {
                "error": "rate_limit_exceeded",
                "message": f"Rate limit exceeded ({limit} requests per hour). For urgent help WhatsApp us at +16134000000",
                "limit": limit,
                "used": request_count,
                "remaining": 0,
                "reset_in_minutes": 60
