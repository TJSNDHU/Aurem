          ...
          <>
            {workflows.length > 0 ? (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className="size-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${wf.color || '#D4AF37'}15` }}>
                          <Zap className="size-5" style={{ color: wf.color || '#D4AF37' }} />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-2 mb-4 overflow-x-auto py-2">
                      ...
                      {(wf.actions || []).map((action, i) => (
                        <React.Fragment key={i}>
                          <ArrowRight className="size-3 text-[#333] flex-shrink-0" />
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        >
                          {wf.status === 'active' ? <Pause className="size-3.5" /> : <Play className="size-3.5" />}
                        </button>
                        <button
              ...
              <div className="p-16 bg-white/80 backdrop-blur-sm border border-[#FF6B00]/20 rounded-xl text-center">
                <Zap className="size-10 text-[#333] mx-auto mb-4" />
          ...
          <div className="grid grid-cols-2 gap-4">
            {WORKFLOW_TEMPLATES.map(template => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div className="size-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${template.color}15` }}>
                      <Zap className="size-5" style={{ color: template.color }} />
                    </div>
                    <div>
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-[#FF6B00]/20 rounded-xl overflow-hidden">
            ...
            {workflows.filter(w => w.runs_today > 0).length > 0 ? (
              ...
              <div className="p-10 text-center">
                <Clock className="size-8 text-[#333] mx-auto mb-3" />
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-[#FF6B00]/20 rounded-2xl w-full max-w-lg p-6">
            ...
            <div className="space-y-2 max-h-[400px] overflow-auto">
              {WORKFLOW_TEMPLATES.map(t => (
                ...
                >
                  <div className="size-9 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${t.color}15` }}>
                    <Zap className="size-4" style={{ color: t.color }} />
                  </div>
                  <div>
