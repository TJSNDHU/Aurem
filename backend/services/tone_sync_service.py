"""
Tone Sync Service - Dynamic Personality for AUREM DIY Voice AI
...
class ToneSyncService:
    """
    Manages dynamic tone adjustment for AUREM voice agents
    ...
    async def analyze_voice_sentiment(
        ...
        Returns:
            {
                ...
                "voice_settings": Dict,  # To send back to voice engine
                "should_alert": bool
            }
        """
        if self.db is None:
        ...
        try:
            ...
            # Generate voice metadata for tone adjustment
            voice_settings = self._generate_voice_instructions(
    ...
    def _generate_voice_instructions(
        ...
        """
        Generate metadata to send back to AUREM Voice Engine for tone adjustment
        
        This instructs the voice AI to adjust:
        - Speaking pace
        - Pitch
        - Pausing
        - Word choice
        ...
        # Create system prompt update for AUREM voice engine
