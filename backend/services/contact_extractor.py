...
- Channel auto-capture: WhatsApp, AUREM Voice, Email
"""
...
class ContactExtractor:
    ...
    async def extract_from_message(
        ...
        Args:
            ...
            channel: Source channel (whatsapp, aurem_voice, email, web)
    ...
    def _extract_from_channel(
        ...
        elif channel == "aurem_voice" or channel == "voice":
            # AUREM Voice provides caller_id
