...
CHIP_TEMPLATES: Dict[str, Dict[str, Any]] = {
    ...
    "systems_audit": {
        ...
        "build_prompt": lambda inp: (
            ...
            "operating system.\n\n"
            "Owner: Tejinder Sandhu\n"
            "Businesses: AUREM (aurem.live) + AUREM (aurem.live) + A-1 "
    ...
    "specific_knowledge": {
        ...
        "build_prompt": lambda inp: (
            ...
            "AI/full-stack → founded AUREM (autonomous AI platform) + AUREM "
    ...
    "leverage_audit": {
        ...
        "build_prompt": lambda inp: (
            ...
            "3. AUREM.ca (skincare e-commerce) → ~10h/week → early revenue\n"
            ...
            "Assets owned: AUREM codebase, AUREM platform, formulations, "
    ...
    "time_leak": {
        ...
        "build_prompt": lambda inp: (
            ...
            "3. AUREM.ca management — 10h/week\n"
    ...
    "compounding_work": {
        ...
        "build_prompt": lambda inp: (
            ...
            "platform (asset building) · AUREM.ca (asset building) · "
