      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Configure your ORA safety net. Get instant alerts when customers need human attention.
          </p>
        </div>
          ...
          {config.enabled && (
            <>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 ml-8 mt-1">
                  ORA will stop responding until you manually resume or resolve the issue
                </p>
              </div>
            </>
          )}
