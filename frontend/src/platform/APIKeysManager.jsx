  ...
  return (
    <div className="flex-1 overflow-y-auto bg-white/60 p-6">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-light text-[#1A1A2E] tracking-wider mb-2">API Keys</h1>
        ...
        {newKey && (
          <div className="mb-6 p-6 bg-[#D4AF37]/10 border border-[#D4AF37]/30 rounded-lg">
            ...
            <div className="bg-white/80 backdrop-blur-sm p-4 rounded border border-[#FF6B00]/20 mb-4">
            ...
            <div className="bg-white/80 backdrop-blur-sm p-4 rounded border border-[#FF6B00]/20">
              <div className="flex items-center justify-between mb-2">
        ...
        {/* Existing Keys List */}
        <div>
          <h2 className="text-sm font-medium text-[#1A1A2E] mb-4 uppercase tracking-wider">Your API Keys</h2>
          ...
          {apiKeys.length === 0 ? (
            ...
            <div className="space-y-3">
              {apiKeys.map((key) => (
                <div
                  key={key.key_id}
                  className="p-4 bg-white/80 backdrop-blur-sm border border-[#FF6B00]/20 rounded-lg flex items-center justify-between hover:border-[#FF6B00]/15 transition-all"
                >
        ...
        <div className="mt-8 p-6 bg-white/80 backdrop-blur-sm border border-[#FF6B00]/20 rounded-lg">
          ...
          <div className="mt-4 p-3 bg-white/60 rounded border border-[#FF6B00]/20">
