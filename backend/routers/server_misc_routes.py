...
# iter D-76 dedupe — /auth/forgot-password, /auth/reset-password,
# /auth/verify-reset-token moved fully to routes/auth.py (sha256-hashed
# MongoDB-backed reset tokens, single source of truth). The JWT-jti
# variant that used to live here was the loser in the dedupe-audit.
