      ...
      {isConnected ? (
        ...
        <div>
          ...
          <SetupStep
            ...
            description="Once connected, incoming WhatsApp messages will appear in your Unified Inbox with ORA-powered suggestions."
            completed={false}
            active={false}
          />
          ...
          <div style={{ marginTop: 32 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {[
                { icon: Zap, title: "ORA-Powered Responses", desc: "ORA suggests actions for each message" },
