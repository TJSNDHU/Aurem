...
def extract_shape_content(shape, slide, slide_data, assets_dir, slide_num):
    """Extract text and image content from a single shape."""
...
def extract_slide_data(slide, slide_num, assets_dir):
    ...
    for shape in slide.shapes:
        extract_shape_content(shape, slide, slide_data, assets_dir, slide_num)
...
def extract_pptx(file_path, output_dir="."):
    ...
    for slide_num, slide in enumerate(prs.slides):
        slide_data = extract_slide_data(slide, slide_num, assets_dir)
