...
def _validate_and_get_api_keys() -> list[str]:
...
def _print_generation_info(
    ...
    """Imprime informacoes da geracao."""
    print("=" * 60)
...
def _handle_generation_error(e: Exception, i: int, api_keys: list, attempt: int, max_retries: int, retry_delay: int) -> tuple[bool, int]:
    """Trata erros de geracao e retorna (should_retry, wait_time)."""
    error_msg = str(e)
