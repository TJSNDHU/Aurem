...
_BLUE_TEAM_TEMPLATES: dict[str, dict] = {
    ...
    "command_injection": {
        "recommendation": (
            "Replace os.system and os.popen calls, and subprocess invocations "
            "that set shell to True, with subprocess.run using shell=False and "
            "a list of arguments. Never concatenate user input into shell "
            "commands. Validate and sanitize all inputs. Use shlex.quote if shell "
            "is unavoidable."
        ),
        "priority": "CRITICAL",
