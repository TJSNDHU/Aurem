...
def check_structured_data(content: str, passed: list, issues: list):
...
def check_headings(content: str, passed: list, issues: list):
...
def check_author(content: str, passed: list, issues: list):
...
def check_date(content: str, passed: list, issues: list):
...
def check_faq(content: str, passed: list):
...
def check_lists(content: str, passed: list):
    """Check for lists."""
...
def check_tables(content: str, passed: list):
    """Check for tables."""
...
def check_entity(content: str, passed: list):
    """Check for entity recognition (E-E-A-T signal)."""
    entity_patterns = [
...
def check_statistics(content: str, passed: list):
    """Check for original statistics/data."""
    stat_patterns = [
        r'\d+%',                    # Percentages
        r'\$[\d,]+',                # Dollar amounts
...
def check_direct_answers(content: str, passed: list):
    """Check for conversational/direct answer patterns."""
...
def check_page(file_path: Path) -> dict:
    ...
    check_structured_data(content, passed, issues)
    check_headings(content, passed, issues)
    check_author(content, passed, issues)
    check_date(content, passed, issues)
    check_faq(content, passed)
    check_lists(content, passed)
    check_tables(content, passed)
    check_entity(content, passed)
    check_statistics(content, passed)
    check_direct_answers(content, passed)
