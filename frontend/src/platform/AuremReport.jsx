        ...
        <Section testid="report-hero">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 mb-6">
              <div className="w-3 h-3 rounded-full animate-pulse" style={{ background: GOLD, boxShadow: `0 0 16px ${GOLD}` }} />
            ...
            {growth_gaps.map((gap, i) => {
              ...
              return (
                <div key={i} data-testid={`gap-${i}`}
                  ...
                  <div className="w-10 h-10 shrink-0 rounded-lg flex items-center justify-center" style={{ background: 'rgba(239,68,68,0.15)' }}>
            ...
            {aurem_fixes.map((fix, i) => {
              ...
              return (
                <div key={i} data-testid={`fix-${i}`}
                  ...
                  <div className="w-10 h-10 shrink-0 rounded-lg flex items-center justify-center transition-all duration-300 group-hover:scale-110"
                    style={{ background: 'rgba(201,162,39,0.12)', boxShadow: `0 0 0 1px rgba(201,162,39,0.25) inset` }}>
                    <Icon className="w-5 h-5 transition-colors duration-300" style={{ color: GOLD }} />
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {social_proof.map((p, i) => (
              <div key={i} data-testid={`proof-${i}`}
                ...
                <Quote className="w-6 h-6 mb-3" style={{ color: GOLD }} />
          ...
          <div className="rounded-2xl p-8 md:p-12 text-center border"
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <a href="tel:+14314500004" data-testid="cta-call"
                ...
                style={{ background: GOLD, color: '#000' }}>
                <Phone className="w-4 h-4" /> BOOK A DEMO CALL
              </a>
