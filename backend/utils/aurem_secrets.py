...
REQUIRED_SECRETS = {
    ...
    # Optional - Will use defaults. NOT actively used — keep out of important
    # tier so deployments don't surface them as warnings. Resend is the
    # active transactional email provider; SendGrid/OmniDimension are legacy.
    "optional": [
        "ADMIN_WHATSAPP",
        "OPENROUTER_API_KEY",
        "SENDGRID_API_KEY",
...
def init_aurem_security(strict: bool = False):
    ...
    Call this on server startup. Idempotent — only runs once.
    """
