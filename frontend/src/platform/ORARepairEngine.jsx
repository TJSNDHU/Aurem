...
const BeforeAfterCard = ({ title, icon: Icon, before, after, fixCount, color }) => (
  <div className="p-5 rounded-2xl border border-white/30 bg-white/50 backdrop-blur-sm" data-testid={`score-card-${title.toLowerCase()}`}>
    ...
    <div className="flex items-center justify-center gap-4">
      ...
      <ArrowRight className="w-5 h-5 text-[#D4B977] flex-shrink-0" />
      ...
      {expanded && (
        <div className="mt-1 ml-11 p-4 rounded-xl bg-white/40 border border-white/30 space-y-3">
          ...
          <div className="flex items-center gap-2">
            <Sparkles className="w-3 h-3 text-[#D4B977]" />
      ...
      {diffs.map((diff, i) => (
        <div key={diff.fix_id || i}
          ...
          <div className="px-4 py-2.5 flex items-center justify-between"
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full" style={{ background: '#B88759' }} />
            ...
            <Code className="w-3.5 h-3.5" style={{ color: '#6B5744' }} />
          </div>
          {/* Side-by-Side Diff */}
  ...
  >
    ...
    <div className="flex items-start gap-3">
      <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
        ...
        <Icon className="w-5 h-5" style={{ color: tier === 'free' ? '#FF6B00' : tier === 'pro' ? '#fff' : '#FF6B00' }} />
      </div>
    ...
    {selected && (
      <div className="absolute top-3 left-3">
        <CheckCircle className="w-4 h-4" style={{color: tier === 'free' ? '#FF6B00' : '#D4AF37'}} />
      </div>
    )}
  </button>
);
      ...
      <div onClick={e => e.stopPropagation()} className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm mx-4" data-testid="pin-modal">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-[#FF6B00]/10 flex items-center justify-center">
            <Unlock className="w-5 h-5 text-[#FF6B00]" />
          </div>
          <div>
  ...
  if (!history || !Array.isArray(history.history) || history.total_scans === 0) {
    return (
      <div className="text-center py-16">
        <History className="w-12 h-12 text-[#D4AF37]/30 mx-auto mb-3" />
          ...
          <div key={entry.url + i}
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                ...
                {rescanningUrl === entry.url ? (
                  <><Loader2 className="w-3 h-3 animate-spin" /> Comparing with Previous Pulse...</>
                ) : (
            ...
            {entry.github_pr_url && (
              <a href={entry.github_pr_url} target="_blank" rel="noopener noreferrer"
                ...
                <Github className="w-3 h-3" /> View GitHub PR
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6" data-testid="repair-engine-header">
          ...
          <div className="flex gap-1 p-0.5 bg-white/30 rounded-lg w-fit" data-testid="repair-tabs">
            <button onClick={() => setActiveTab('engine')} data-testid="tab-engine"
              ...
              <Wrench className="w-3.5 h-3.5" /> Repair Engine
            </button>
            <button onClick={() => setActiveTab('history')} data-testid="tab-history"
              ...
              <History className="w-3.5 h-3.5" /> Pulse History
            </button>
            <button onClick={() => {
              ...
              <Settings className="w-3.5 h-3.5" /> ORA Settings
            </button>
            <button onClick={() => setActiveTab('training')} data-testid="tab-training"
              ...
              <Languages className="w-3.5 h-3.5" /> Training
            </button>
          </div>
        </div>
        ...
        {activeTab === 'ora-settings' && (
          <div className="space-y-6" data-testid="ora-settings-panel">
            ...
            <div className="p-5 rounded-2xl border border-white/30 bg-white/50 backdrop-blur-sm">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-[#D4AF37]/10">
              ...
              <div className="flex gap-2">
                ...
                >
                  {oraSettingsLoading ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Save className="w-3.5 h-3.5" />}
            ...
            <div className="p-5 rounded-2xl border border-white/30 bg-white/50 backdrop-blur-sm">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-[#4ade80]/10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="p-5 rounded-2xl border border-white/30 bg-white/50 backdrop-blur-sm">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-[#FF6B00]/10">
              ...
              <div className="p-5 rounded-2xl border border-white/30 bg-white/50 backdrop-blur-sm">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-[#64C8FF]/10">
                    <Globe className="w-4 h-4 text-[#64C8FF]" />
                  </div>
                  <div>
                ...
                <div className="flex gap-2 mb-3">
                  ...
                  >
                    {trainUrlLoading ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Link className="w-3.5 h-3.5" />}
                    Crawl
                  </button>
                </div>
                <div className="flex gap-2">
            ...
            <div className="p-5 rounded-2xl border border-white/30 bg-white/50 backdrop-blur-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={fetchTrainingFiles} disabled={trainingLoading}
                  ...
                  <RefreshCw className={`w-3.5 h-3.5 text-[#888] ${trainingLoading ? 'animate-spin' : ''}`} />
                </button>
              </div>
                  ...
                  {trainingFiles.map(f => (
                    <div key={f.file_id} data-testid={`training-item-${f.file_id}`}
                      ...
                      <div className={`w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 ${
                        ...
                        {f.file_category === 'audio' ? <Music className="w-4 h-4 text-[#FF6B00]" /> :
                         f.file_category === 'web' ? <Globe className="w-4 h-4 text-[#64C8FF]" /> :
        ...
        <div className="mb-6 p-5 bg-white/70 backdrop-blur-sm border border-white/40 rounded-2xl" data-testid="repair-url-input">
          ...
          <div className="flex gap-2 mt-3">
            <button onClick={handleSEO} disabled={isAnalyzing} data-testid="analyze-seo-btn"
              ...
              {seoLoading ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Eye className="w-3.5 h-3.5" />}
            ...
            <button onClick={handleGEO} disabled={isAnalyzing} data-testid="analyze-geo-btn"
              ...
              {geoLoading ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <BrainCircuit className="w-3.5 h-3.5" />}
            ...
            <button onClick={handleA11y} disabled={isAnalyzing} data-testid="analyze-a11y-btn"
              ...
              {a11yLoading ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Accessibility className="w-3.5 h-3.5" />}
        ...
        {a11yFixes.length > 0 && (
          <div className="mb-6" data-testid="a11y-fixes-section">
            <div className="flex items-center gap-2 mb-3">
              <Accessibility className="w-4 h-4 text-[#64C8FF]" />
        ...
        {deployStatus && (
          <div className="mb-6 p-6 rounded-2xl border-2 border-[#4ade80]/30 bg-gradient-to-br from-[#4ade80]/5 to-white/50" data-testid="deploy-success">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-[#4ade80]/20">
                <CheckCircle className="w-5 h-5 text-[#4ade80]" />
              </div>
              <div>
        ...
        {deployedCount > 0 && (
          <div className="mb-6 p-6 rounded-2xl border-2 border-[#FF6B00]/30 bg-gradient-to-br from-[#FF6B00]/5 to-white/50" data-testid="origin-write-section">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #FF6B00, #1a5c33)' }}>
            ...
            <div className="flex gap-3">
              <button onClick={handleOriginCommit} disabled={originLoading} data-testid="commit-origin-btn"
                ...
                style={{ background: 'linear-gradient(135deg, #FF6B00, #1a5c33)' }}>
                {originLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : <Lock className="w-4 h-4" />}
              ...
              {originResult && (
                <button onClick={handleOriginVerify} disabled={verifyLoading} data-testid="verify-origin-btn"
                  ...
                  {verifyLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : <ExternalLink className="w-4 h-4" />}
        ...
        {hasApprovedFixes && !deployStatus && (
          <div className="mb-6 p-6 rounded-2xl border-2 border-[#D4AF37]/30 bg-gradient-to-br from-[#D4AF37]/5 to-white/50" data-testid="deploy-section">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #D4AF37, #B88759)' }}>
              ...
              {!deployPreview && (
                <button onClick={handleDeployPreview} disabled={deployLoading} data-testid="preview-deploy-btn"
                  className="px-5 py-2.5 rounded-lg font-bold text-sm text-white hover:opacity-90 transition-all disabled:opacity-50 flex items-center gap-2"
                  style={{ background: 'linear-gradient(135deg, #D4AF37, #B88759)' }}>
                  {deployLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : <Eye className="w-4 h-4" />}
              ...
              <div className="space-y-5">
                ...
                <button onClick={handleCheckout} disabled={checkoutLoading} data-testid="checkout-btn"
                  ...
                  {checkoutLoading ? (
                    ...
                    <><CreditCard className="w-4 h-4" /> Pay ${selectedTier === 'pro' ? 99 : 29} — Deploy {deployPreview.fix_count} Fixes</>
                  )}
                </button>
                )}
                <p className="text-center text-[9px] text-[#888]">
                  <Lock className="w-2.5 h-2.5 inline mr-1" />Secure payment via Stripe. {selectedTier === 'pro' ? 'GitHub PR created automatically after payment.' : 'Patch file available immediately after payment.'}
                </p>
              </div>
            )}
          </div>
        ...
        {(seoResult || a11yResult || geoResult) && fixes.length > 0 && (
          <div className="p-5 rounded-2xl border border-[#D4B977]/20 bg-gradient-to-r from-[#D4B977]/5 to-[#4ade80]/5" data-testid="ai-summary">
            <div className="flex items-center gap-2 mb-3">
              <Sparkles className="w-5 h-5 text-[#D4B977]" />
        ...
        {!seoResult && !a11yResult && !geoResult && !isAnalyzing && !rescanComparison && (
          <div className="text-center py-16" data-testid="repair-empty-state">
            <div className="w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center bg-gradient-to-br from-[#D4AF37]/20 to-[#4ade80]/20">
