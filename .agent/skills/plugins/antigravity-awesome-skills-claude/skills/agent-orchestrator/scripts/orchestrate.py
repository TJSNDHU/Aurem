...
def _generate_single_plan(skills: list[dict], query: str) -> dict:
...
def _generate_sequential_plan(skills: list[dict], query: str) -> dict:
...
def _generate_parallel_plan(skills: list[dict], query: str) -> dict:
...
def _generate_primary_support_plan(skills: list[dict], query: str) -> dict:
...
_PLAN_GENERATORS = {
    "single": _generate_single_plan,
    "sequential": _generate_sequential_plan,
    "parallel": _generate_parallel_plan,
    "primary_support": _generate_primary_support_plan,
}


def generate_plan(skills: list[dict], query: str, pattern: str) -> dict:
    """Generate an execution plan based on the pattern."""
    generator = _PLAN_GENERATORS.get(pattern)
    if generator:
        return generator(skills, query)
