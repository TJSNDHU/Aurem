...
class BaseSchemaValidator:
    ...
    def _validate_single_rels_file(self, rels_file, all_referenced_files):
        """Validate a single .rels file and update the set of referenced files.

        Returns a list of error strings for this file.
        """
        errors = []
        try:
