...
class BaseSchemaValidator:
    ...
    def _collect_target_files(self):
        """Collect all non-reference files in the unpacked directory."""
        all_files = []
    ...
    def _resolve_rels_target(self, rels_file, target):
        """Resolve a relationship target path relative to the .rels file location."""
    ...
    def _process_rels_file(self, rels_file, all_referenced_files):
        """Process a single .rels file, returning errors and updating referenced set."""
        errors = []
        try:
            ...
            for rel in rels_root.findall(
                ...
                if target and not target.startswith(
                    ...
                    target_path = self._resolve_rels_target(rels_file, target)
    ...
    def validate_file_references(self):
        ...
        all_files = self._collect_target_files()
        ...
        for rels_file in rels_files:
            errors.extend(self._process_rels_file(rels_file, all_referenced_files))
