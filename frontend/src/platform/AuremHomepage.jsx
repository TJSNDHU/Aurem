...
const AuremHomepage = () => {
  ...
  // iter 332b D-18 — Founder-locked behavior: the top-right "Log In"
  // ALWAYS lands on /my. The previous "smart" redirect peeked at
  // localStorage and bounced devs/admins to their own dashboards, which
  // is surprising when a leftover dev token from an earlier session
  // sends you to /developers/dashboard instead of the customer login.
  // Single destination. No surprises.
  const handleSignIn = (_e) => { /* no-op — Link href owns the navigation */ };
    ...
    <div className="aurem-home" data-testid="aurem-homepage">
      ...
      <nav data-testid="nav">
        ...
        <div className="nav-actions">
          <Link to="/my" className="nav-login" data-testid="nav-link-login" aria-label="Log in to your AUREM account" onClick={handleSignIn}>
