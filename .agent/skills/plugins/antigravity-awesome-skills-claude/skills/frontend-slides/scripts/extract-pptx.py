...
def _extract_shape_text(shape, slide, slide_data):
    """Extract text content from a shape into the slide data."""
...
def _extract_shape_image(shape, slide_data, slide_num, assets_dir):
    """Extract an image from a shape into the slide data."""
...
def _extract_slide(slide, slide_num, assets_dir):
    ...
    for shape in slide.shapes:
        _extract_shape_text(shape, slide, slide_data)
        _extract_shape_image(shape, slide_data, slide_num, assets_dir)
...
def extract_pptx(file_path, output_dir="."):
    ...
    for slide_num, slide in enumerate(prs.slides):
        slide_data = _extract_slide(slide, slide_num, assets_dir)
